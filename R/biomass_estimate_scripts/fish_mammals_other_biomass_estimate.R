...
##########################################################
print("Calculating and saving mesopelagic fish biomass estimate and uncertainty")
...
##################################################################
print("Calculating and saving epipelagic, demersal fish, cephalopod and invertebrate biomass estimate and uncertainty")

### For each marine model, extract average map of global fish biomass from 1850-1960
# Open CESM
boats_cesm_tcb_1850_1860 <- as.matrix(read.table("./data/fish_mammals_other/boats_cesm_tcb_1850_1860_ave.csv", sep = ","))
### Open FEISTY
