...
##########################################################
print("Fitting global bacteria abundance statistical model")
...
print("Plotting main effects plots for bacteria abundance statistical model")
...
print("Calculating uncertainty of global bacteria abundance estimate")
...
##########################################################
print("Calculating global bacteria biomass and uncertainty")
...
print("Saving global bacteria biomass estimate, and predictions")
...
#########################################################################
print("Projecting future bacteria biomass")
