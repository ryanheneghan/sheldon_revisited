...
##########################################################
print("Fitting non-giant rhizaria mesozoo biomass statistical model")
## Non rhizaria mesozoo
zoo_dat <- readRDS("./data/zooplankton/mesozoo_dat.RDS")
...
print("Plotting main effects plots for global giant rhizaria mesozoo biomass statistical model")
...
##########################################################
print("Predicting total mesozoo biomass")
...
##########################################################
print("Saving global total mesozoo biomass estimate and uncertainty")
