...
##########################################################
print("Calculating % contribution of pico, nano and microphytoplankton to total chlorophyll")

# Import chlorophyll
chlo <- as.matrix(read.table("./data/phytoplankton/chlo_modis.csv", sep = ","))
...
##########################################################
print("Calculating total chlorophyll in euphotic zone")

# We use the equations in table 4 of Uitz et al., 2006 doi:10.1029/2005JC003207
# Import euphotic zone depth
euphs <- as.matrix(read.table("./data/phytoplankton/euphotic_depth.csv", sep = ","))

# Import mixed layer depth
mlds <- as.matrix(read.table("./data/phytoplankton/mixed_layer_depth.csv", sep = ","))
...
##########################################################
print("Convert total euphotic zone chlorophyll to wet weight biomass of pico, nano and microphytoplankton")
...
##          SIZE RANGES
##########################################################
print("Calculate global biomass and error estimate of pico, nano and microphytoplankton")
